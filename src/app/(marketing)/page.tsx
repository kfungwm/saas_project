  ...
  return (
    <>
      ...
      <section className="bg-primary text-primary-foreground">
        <div className="container py-16 fle flex-col gap-16 px-8 md:px-16">
          <h2 className="text-3xl text0center text-balance mb-5">
            Trusted by the top modern companies
          </h2>
          <div className="grid grid-cols-2 md:gris-cols-3 xl:grid-cols-5 gap-16">
